...
커버리지 감사 결과 액션 가능한 누락/약반영 포인트를 추가 반영했습니다. 이후 시험 방향에 맞지 않는 조문·항·호 번호 세부 암기형, OCR 찌꺼기, 고시번호·문서번호·기사형 잡음, 문장 조각형 빈칸, 가짜 사례형·순서형, 표/슬라이드 잔해 문제를 제거했습니다. 추가로 같은 근거 문장을 객관식·빈칸·비교형으로 반복한 중복 문항 355개를 제거해, 근거 포인트별 대표 문제 1개만 남겼습니다. 최종 검증에서 잔여 조·항·호 번호 문제, 출처 누락, 정답·해설 누락, 중복 ID와 중복 근거 문항은 0개입니다.
